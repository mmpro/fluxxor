...
_delay            = require('lodash/function/delay');
...
Dispatcher.prototype.processQueue = function() {
  ...
  // if(!this.activeQueue && queueSize > 0) {
  //   this.activeQueue = _delay(this.processQueue.bind(this), interval);
  // } else {
  //   if(!this.activeQueue && queueSize === 0) {
  //     clearTimeout(this.activeQueue);
  //   }
  // }
