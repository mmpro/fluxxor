...
var Dispatcher = function(stores) {
  ...
  setInterval(function() {
    if (!that.currentDispatch && that.dispatchQueue.length > 0) {
      var actionToDispatch = that.dispatchQueue.shift();
      //console.info('Dispatching', actionToDispatch);
      that.dispatchInterceptor(actionToDispatch, that._boundDispatch);
    }
  }, 0)
